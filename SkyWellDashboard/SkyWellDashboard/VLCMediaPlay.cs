...
namespace SkyWellDashboard
{
    ...
    public class VLCMediaPlay
    {
        ...
        //用于播放节目时，转录节目
        //private static string program_arg = "--sout "#transcode{vcodec=h264,vb=500,fps=5}:duplicate{dst=file{dst=D:\\\\video\\\\%filename3%,no-overwrite}}"";
        private static string[] arguments = { "-I", "dummy", "--ignore-config", "--no-video-title","--network-caching=110", plugin_arg  };
        ...
        /// <returns></returns>
        public libvlc_instance_t Create_Media_Instance()
        {
        ...
        /// <param name="arguments"></param>
        /// <returns></returns>
        public libvlc_instance_t Create_Media_Instance(string[] arrarguments)
        {
            libvlc_instance_t libvlc_instance = IntPtr.Zero;
            IntPtr argvPtr = IntPtr.Zero;
            ...
            try
            {
                ...
                //将string数组转换为指针
                argvPtr = StrToIntPtr(arrarguments);
                if (argvPtr == null || argvPtr == IntPtr.Zero)
                {
                    return IntPtr.Zero;
                }
                ...
                //设置启动参数
                libvlc_instance = SafeNativeMethods.libvlc_new(arrarguments.Length, argvPtr);
                if (libvlc_instance == null || libvlc_instance == IntPtr.Zero)
                {
                    return IntPtr.Zero;
                }
        ...
        public void Release_Media_Instance(libvlc_instance_t libvlc_instance)
        {
            try
            {
        ...
        /// <returns></returns>
        public libvlc_media_player_t Create_MediaPlayer(libvlc_instance_t libvlc_instance, IntPtr handle)
        {
        ...
        public void Save_MediaPlayer(libvlc_media_player_t libvlc_media_player, string url)
        {
        ...
        /// </summary>
        /// <param name="libvlc_media_player"></param>
        public void UnSave_MediaPlayer(libvlc_media_player_t libvlc_media_player)
        {
            try
            {
        ...
        public void Release_MediaPlayer(libvlc_media_player_t libvlc_media_player)
        {
            try
            {
                if (libvlc_media_player != IntPtr.Zero ||
        ...
        /// <returns></returns>
        public bool NetWork_Media_Play(libvlc_instance_t libvlc_instance, libvlc_media_player_t libvlc_media_player, string url)
        {
            IntPtr pMrl = IntPtr.Zero;
        ...
        /// <returns></returns>
        public bool LocationPath_Media_Play(libvlc_instance_t libvlc_instance, libvlc_media_player_t libvlc_media_player, string url)
        {
            IntPtr pMrl = IntPtr.Zero;
            libvlc_media_t libvlc_media = IntPtr.Zero;
        ...
        /// <param name="libvlc_media_player">VLC MediaPlayer变量</param>
        /// <returns></returns>
        public bool MediaPlayer_Pause(libvlc_media_player_t libvlc_media_player)
        {
            try
            {
                if (libvlc_media_player == IntPtr.Zero ||
        ...
        /// <param name="libvlc_media_player">VLC MediaPlayer变量</param>
        /// <returns></returns>
        public bool MediaPlayer_Stop(libvlc_media_player_t libvlc_media_player)
        {
            try
            {
                if (libvlc_media_player == IntPtr.Zero ||
        ...
        /// <param name="libvlc_media_player">VLC MediaPlayer变量</param>
        /// <returns></returns>
        public bool MediaPlayer_Forward(libvlc_media_player_t libvlc_media_player)
        {
            double time = 0;
        ...
        /// <param name="libvlc_media_player">VLC MediaPlayer变量</param>
        /// <returns></returns>
        public bool MediaPlayer_Back(libvlc_media_player_t libvlc_media_player)
        {
            double time = 0;
        ...
        /// <param name="libvlc_media_player">VLC MediaPlayer变量</param>
        /// <returns></returns>
        public bool MediaPlayer_IsPlaying(libvlc_media_player_t libvlc_media_player)
        {
            try
            {
                if (libvlc_media_player == IntPtr.Zero ||
        ...
        /// <returns></returns>
        public bool TakeSnapShot(libvlc_media_player_t libvlc_media_player, string path, string name)
        {
            try
            {
        ...
        /// <param name="libvlc_media_player"></param>
        /// <returns></returns>
        public bool GetMedia(libvlc_media_player_t libvlc_media_player)
        {
        ...
        /// <param name="libvlc_media_player"></param>
        /// <returns></returns>
        public int GetDisplayedPictures(libvlc_media_player_t libvlc_media_player)
        {
            libvlc_media_t media = IntPtr.Zero;
        ...
        public bool SetFullScreen(libvlc_media_player_t libvlc_media_player, int isFullScreen)
        {
            try
            {
                if (libvlc_media_player == IntPtr.Zero ||
